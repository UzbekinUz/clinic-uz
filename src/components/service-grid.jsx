import {Activity, ArrowRight, Stethoscope, Users } from "lucide-react";
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  messaging, and monitoring, providing convenience when you need
                  it most.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Urgent care delivers prompt treatment for non-life-threatening
                  injuries and illnesses, saving you a trip to the emergency
                  room.
                </p>
              </div>
            </div>
